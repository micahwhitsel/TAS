...
class CAV_Training_Base_B : CommonBlufor {
    headgear[] = {"rhsusf_ach_helmet_ocp"};
    goggles[] = {"rhs_googles_clear"};
    uniform[] = {"LOP_U_ISTS_Fatigue_19"};
    ...
    primary[] = {"rhs_weap_m4a1_grip","rhsusf_acc_SFMB556","rhsusf_acc_anpeq15_bk","rhsusf_acc_ACOG_RMR","rhsusf_acc_grip1"};
    secondary[] = {""};
    launcher[] = {""};
...
class CAV_Training_Base_C : CommonBlufor {
